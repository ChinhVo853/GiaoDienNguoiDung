...
function DangKy()
{
  ...
  //lưu value nhập vào của họ tên ở input
  ...
  //lưu value nhập vào của địa chỉ ở input
  const [diaChi, setDiaChi] = useState('');

  //lưu value nhập vào của số điện thoại ở input
  ...
  const Regester = (event) => {
    ...
    //ở đây sẽ giúp người dùng đăng ký với đầy đủ thông tin
    //khi đăng ký thành công sẽ chuyển url thành DANGNHAP
    ...
    return(
        ...
        <div className="container1">
            ...
            <form onSubmit={Regester} className="form">
              <input
